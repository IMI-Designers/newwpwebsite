<?php
/**
 * digititral functions and definitions
 *
 * @package WordPress
 ...
 * @since digititral 1.0
 */
 load_theme_textdomain( 'digititral' );
	add_theme_support( 'automatic-feed-links' );
	add_theme_support( 'title-tag' );
	add_theme_support( 'post-thumbnails' );
	set_post_thumbnail_size( 825, 510, true );
	register_nav_menus( array(
		'primary' => __( 'Primary Menu',      'digititral' ),
		'header'  => __( 'Header menu', 'digititral' ),
		'footer'  => __( 'Footer menu', 'digititral' ),
	) );
...
function wpdocs_theme_slug_widgets_init() {
    register_sidebar( array(
        'name'          => __( 'Main Sidebar', 'digititral' ),
        'id'            => 'sidebar-1',
        'description'   => __( 'Widgets in this area will be shown on all posts and pages.', 'digititral' ),
...
function testi_post_type() {
	$labels = array(
		'name'                => _x( 'features', 'Post Type General Name', 'digititral' ),
		'singular_name'       => _x( 'features', 'Post Type Singular Name', 'digititral' ),
		'menu_name'           => __( 'features', 'digititral' ),
		'parent_item_colon'   => __( 'Parent features', 'digititral' ),
		'all_items'           => __( 'All features', 'digititral' ),
		'view_item'           => __( 'View features', 'digititral' ),
		'add_new_item'        => __( 'Add New features', 'digititral' ),
		'add_new'             => __( 'Add New', 'digititral' ),
		'edit_item'           => __( 'Edit features', 'digititral' ),
		'update_item'         => __( 'Update features', 'digititral' ),
		'search_items'        => __( 'Search features', 'digititral' ),
		'not_found'           => __( 'Not Found', 'digititral' ),
		'not_found_in_trash'  => __( 'Not found in Trash', 'digititral' ),
	);
	$args = array(
		'label'               => __( 'features', 'digititral' ),
		'description'         => __( 'features news and reviews', 'digititral' ),
		'labels'              => $labels,
		'supports'            => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', ),
		'taxonomies'          => array( 'genres' ),	
		'hierarchical'        => false,
